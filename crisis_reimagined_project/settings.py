"""
Django settings for crisis_reimagined_project project.
...
INSTALLED_APPS = [
    'crisis_reimagined_app.apps.CrisisReimaginedAppConfig',
    'admin_interface',
    'colorfield',
    'solo',
...
ROOT_URLCONF = 'crisis_reimagined_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'crisis_reimagined_app.context_processors.get_git_info',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'crisis_reimagined_project.wsgi.application'
...
GIT_REPO = 'https://github.com/sfu-dhil/crisis-reimagined'
