"""
Django settings for reimagining_project project.
...
INSTALLED_APPS = [
    'reimagining_app.apps.ReimaginingAppConfig',
    'admin_interface',
    'colorfield',
    'solo',
...
ROOT_URLCONF = 'reimagining_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'reimagining_app.context_processors.get_git_info',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'reimagining_project.wsgi.application'
...
GIT_REPO = 'https://github.com/sfu-dhil/reimagining'
